  ...
  constructor(){
    ...
    this.state = {
      movies: [
        ...
        { _id: 3, Title: 'Kagemusha', Description: 'A petty thief is forced to choose between death and impersonating a warlord. His initial enjoyment gives way as war approaches.', ImagePath: 'https://via.placeholder.com/150' }
      ]
    }
  }
